...
parser.add_argument('--dataset_name', type=str, default='Instant_Video_5',
                    help='dataset name')
parser.add_argument('--dataset_path', type=str, default='/home/d1/xxx/data/Instant_Video_5/Instant_Video_5.json',
...
args.dataset_name = 'Tools_and_Home_Improvement_5'
args.dataset_path = '/home/xxx/code/GNN/ReviewGraph/data/'+args.dataset_name+'/'+args.dataset_name+'.json'
args.vec_dim = 64
