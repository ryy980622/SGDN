...
GLOVE_PATH = '/home/ryy/code/GNN/ReviewGraph/glove/glove.6B.100d.txt'
GLOVE_TMP_PATH = '/home/ryy/code/GNN/ReviewGraph/glove/glove.6B.100d.word2vec.txt'
...
class Args:
    ...
    dataset_name = 'Tools_and_Home_Improvement_5'
    # dataset_path = '/home/d1/shuaijie/data/Clothing_5/Clothing_5.json'
    dataset_path = '/home/ryy/code/GNN/ReviewGraph/data/'+dataset_name+'/'+dataset_name+'.json'
